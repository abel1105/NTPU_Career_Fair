        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="post_form" method="post" class="form-horizontal" action="/career/auth/{{$fair->year}}/post/{{$post->id}}/update">
                        {!! csrf_field() !!}
                        <div class="form-group"><label class="col-md-2 control-label">標題</label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-8"><input type="text" class="form-control" name="title" value="{{$post->title}}" placeholder="標題名稱" required></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-md-2 control-label">內文</label>
                            <div class="col-sm-10">
                                <textarea name="content" id="editor" rows="10" cols="80" placeholder="內文" required>{!! $post->content !!}</textarea>
                                <script>
                                    ...
                                    <div class="tabs-container">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="img-tab-2" class="tab-pane active ">
                                                <div class="panel-body">
                                                    <form id="uploadimagePI" class="dropzone" action="/career/auth/upload">
                                                        {!! csrf_field() !!}

            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>編輯活動<small>於{{session('year')}}年度就業博覽會</small></h5>
                    ...
                    <div class="ibox-content">
                        <form id="lecture_form" method="post" class="form-horizontal" action="/career/auth/{{session('year')}}/lecture/{{$lecture->id}}/update">
                            {!! csrf_field() !!}
                            <div class="form-group"><label class="col-md-2 control-label">標題</label>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-8"><input type="text" class="form-control" name="title" value="{{$lecture->title}}" placeholder="標題名稱" required></div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="data_1"><label class="col-md-2 control-label">日期/時間</label>
                                <div class="row">
                                    <div class="input-group date col-sm-2 pull-left" style="padding-left: 15px;">
                                        <input type="text" class="form-control" name="date" value="{{$lecture->date}}" required>
                                        <span class="input-group-addon"><i class="fa fa-calendar" ></i></span>
                                    </div>
                                    <div class="input-group col-sm-2 pull-left clockpicker" data-autoclose="true" style="padding-left: 15px;">
                                        <input type="text" class="form-control" name="start" placeholder="開始時間" value="{{$lecture->start}}" required>
                                        <span class="input-group-addon">
                                            <span class="fa fa-clock-o"></span>
                                        </span>
                                    </div>
                                    <div class="input-group col-sm-2 pull-left clockpicker" data-autoclose="true" style="padding-left: 15px;">
                                        <input type="text" class="form-control" name="end" placeholder="結束時間" value="{{$lecture->end}}" required>
                                        <span class="input-group-addon">
                                            <span class="fa fa-clock-o"></span>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group"><label class="col-md-2 control-label">地點</label>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-4"><input type="text" class="form-control" name="place" value="{{$lecture->place}}" placeholder="地點" required></div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control" name="type" id="">
                                                @foreach($category as $value)
                                                    <option value="{{$value->id}}" {{$value->id != $lecture->type ?: 'selected'}}>{{ $value->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                            ...
                            <div class="form-group"><label class="col-md-2 control-label">內文</label>
                                <div class="col-sm-10">
                                    <textarea name="info" id="editor" rows="10" cols="80" placeholder="內文" required>{!! $lecture->info !!}</textarea>
                                    <script>
                                        CKEDITOR.replace( 'editor');
                                    </script>
                                </div>
                            </div>
                            <input type="hidden" name="fair_id" value="{{$lecture->fair_id}}">
                            <div class="hr-line-dashed"></div>
                                        ...
                                        <div class="tabs-container">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="img-tab-2" class="tab-pane  active ">
                                                    <div class="panel-body">
                                                        <form id="uploadimageLI" class="dropzone" action="/career/auth/upload">
                                                            {!! csrf_field() !!}

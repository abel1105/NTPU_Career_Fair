            ...
            <div class="col-lg-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <form id="link_form" method="post" class="form-horizontal" action="/career/auth/link/create">
                                {!! csrf_field() !!}
                                <div class="form-group"><label class="col-md-2 control-label">名稱</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="name" value="" placeholder="連結名稱" required>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-md-2 control-label">連結</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="link" placeholder="連結" required>
                                    </div>
                                </div>
                                <div class="form-group" id="data_1"><label class="col-md-2 control-label">圖片</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="img" value="" placeholder="圖片連結" required>
                                    </div>
                                </div>

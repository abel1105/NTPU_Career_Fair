...
@section('content')
    <div class="row">
            ...
            <div class="wrapper wrapper-content animated fadeInUp">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>活動分類 <small>點一下icon即可在右邊進行編輯</small></h5>
                        <div class="ibox-tools">
                            {{--<a href="#" id="delete" class="btn btn-danger btn-primary btn-xs">刪除</a>--}}
                        </div>
                    </div>
                    <div class="ibox-content">
                        <div id="all-cat" class="row icons-box">
                        @foreach($category as $value)
                            <div id="cat-{{$value->id}}" class="cat infont col-md-3 col-sm-4">
                                <a href="#" style="color:{{$value->color}}">
                                    <i class="fa {{$value->fontawesome}}" style="color:{{$value->color}}"></i>
        ...
        <div class="col-lg-5">
            <div class="wrapper wrapper-content animated fadeInUp">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5 id="dynamic-h5">建立新分類</h5>
                        <div id="dynamic-btn" class="ibox-tools" style="display:none;">
                            <a href="#" id="add" class="btn btn-primary btn-xs">新增</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form id="lecture_form" method="post" class="form-horizontal" action="">
                            <input type="hidden" name="id" />
                            {!! csrf_field() !!}
                            <div class="form-group"><label class="col-md-2 control-label">名稱</label>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-8"><input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="分類名稱" required></div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-md-2 control-label">Icon</label>
                                <div class="col-sm-10">
                                    <div id="select-icon" class="row">
                                        <div class="col-md-8">
                                            <a href="#" class="btn btn-primary btn-m" data-toggle="modal" data-target="#icon_modal">選擇Icon</a>
                                            <div class="preview" style="float: right;"></div>
                                        </div>
                                    <input type="hidden" name="fontawesome" placeholder="選擇icon" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-md-2 control-label">顏色</label>
                                <div class="col-sm-10">
                                    <div id="select-color" class="row">
                                        <div class="col-md-8">
                                            <a href="#" class="btn btn-primary btn-m" data-toggle="modal" data-target="#color_modal">選擇顏色</a>
                                            <div class="preview" style="float: right;"></div>
                                        </div>
                                        <input type="hidden" name="color" placeholder="選擇顏色" required/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-sm btn-primary m-t-n-xs save" type="button"><strong>新增</strong></button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal inmodal" id="icon_modal" tabindex="-1" role="dialog"  aria-hidden="true">
    ...
    <div class="modal inmodal" id="color_modal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated fadeIn">
                <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <div class="ibox-content">
                        <h4>選擇顏色</h4>
                        <ul class="color-list" style="padding-left: 0;list-style: none;">
                            <li data-color="#72c02c" style="background: #72c02c;"></li>
                            <li data-color="#3498db" style="background: #3498db;"></li>
                            <li data-color="#e67e22" style="background: #e67e22;"></li>
                            <li data-color="#e74c3c" style="background: #e74c3c;"></li>
                            <li data-color="#ecf0f1" style="background: #ecf0f1;"></li>
                            <li data-color="#9b6bcc" style="background: #9b6bcc;"></li>
                            <li data-color="#27d7e7" style="background: #27d7e7;"></li>
                            <li data-color="#9c8061" style="background: #9c8061;"></li>
                            <li data-color="#4765a0" style="background: #4765a0;"></li>
                            <li data-color="#79d5b3" style="background: #79d5b3;"></li>
                            <li data-color="#a10f2b" style="background: #a10f2b;"></li>
                            <li data-color="#18ba9b" style="background: #18ba9b;"></li>
                        </ul>
                    </div>
                    <div class="row">
                        <button type="button" class="btn btn-white pull-right m-t" data-dismiss="modal">關閉</button>

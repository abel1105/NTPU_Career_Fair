            ...
            <div class="col-lg-6">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>編輯職缺&nbsp;&nbsp;&nbsp;<small>於{{session('year')}}年度就業博覽會</small></h5>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <form id="partner_form" method="post" class="form-horizontal" action="/career/auth/partner/update/{{$link->id}}">
                                {!! csrf_field() !!}
                                <div class="form-group"><label class="col-md-2 control-label">名稱</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="company" value="{{$link->company}}" placeholder="公司名稱" required>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-md-2 control-label">檔案</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="link" value="{{$link->link}}" placeholder="職缺檔案" required>
                                    </div>
                                </div>
                                <div class="form-group" id="data_1"><label class="col-md-2 control-label">圖片</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="img" value="{{$link->img}}" placeholder="公司Logo" required>
